...
class EKYCUnsuccessView : UIView {
    ...
    func setupLayers() {
        backCrossView = UIView(frame: animationFrame())
        ...
        backCrossLayer!.lineJoin = kCALineCapSquare
        ...
        frontCrossView = UIView(frame: animationFrame())
        ...
        frontCrossLayer!.lineJoin = kCALineCapSquare
    ...
    func createScaledCrossPath(scale: CGFloat) -> UIBezierPath {
        var leftTopPoint: CGPoint = CGPoint(x: 13, y: 13)
        var leftBottomPoint: CGPoint = CGPoint(x: 13, y: 39)
        var rightTopPoint: CGPoint = CGPoint(x: 39, y: 13)
        var rightBottomPoint: CGPoint = CGPoint(x: 39, y: 39)

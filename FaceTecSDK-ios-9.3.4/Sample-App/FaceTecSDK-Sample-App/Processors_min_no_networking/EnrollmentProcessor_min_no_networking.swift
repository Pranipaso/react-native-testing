...
class EnrollmentProcessor_min_no_networking: NSObject, FaceTecFaceScanProcessorDelegate {
    ...
    init(fromViewController: UIViewController, sessionToken: String) {
        ...
        let enrollmentSessionViewController = FaceTec.sdk.createSessionVC(faceScanProcessorDelegate: self, sessionToken: sessionToken)
        fromViewController.present(enrollmentSessionViewController, animated: true, completion: nil)
    }
